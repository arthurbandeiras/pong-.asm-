...
;limpa si, di, e define onde a bolinha começa
	...
	desenha_cabecalho:
		...
		call desenha_lateral	; desenha as bordas laterais da tela
main:
...
set_caracter1:			;primeira linha do cabeçalho
...
l4:
		...
		inc		dl			;avanca a coluna
    	loop    l4
set_caracter2:			;segunda linha do cabeçalho
...
altera_v_printa:	; usa a variável inteira para printar a velocidade da bola
	mov ax, 0
...
desenha_lateral:
	mov		byte[cor],branco_intenso	;borda baixo (x1, y1, x2, y2)
	mov		ax,0
	push		ax
	mov		ax,0
	push		ax
	...
	mov		byte[cor],branco_intenso	;borda cima (x1, y1, x2, y2)
	mov		ax,0
	push		ax
	mov		ax,479
	push		ax
	...
	mov		byte[cor],branco_intenso	;borda esquerda (x1, y1, x2, y2)
	mov		ax,0
	push		ax
	mov		ax,0
	push		ax
	...
	mov		byte[cor],branco_intenso	;borda direita (x1, y1, x2, y2)
	mov		ax,639
	push		ax
	mov		ax,0
	push		ax
...
ponto_play	dw	0			;variáveis para contagem
ponto_pc	dw	0
pnt_play_str	db	'00'	;variáveis para printar
pnt_pc_str		db	'00'
;*************************************************************************
segment stack stack
    		resb 		512
